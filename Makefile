...
release-linux:
	godot4 --export-release "Linux/X11" "build/TheCommune_$(version)_linux64.bin"

release-macos:
	godot4 --export-release "macOS" "build/TheCommune_$(version)_osx64.zip"

release-windows:
	godot4 --export-release "Windows Desktop" "build/TheCommune_$(version)_windows64.exe"
